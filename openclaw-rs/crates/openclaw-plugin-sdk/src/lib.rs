//! OpenClaw Plugin SDK
//!
//! This crate provides the core traits and types for building OpenClaw plugins.
//! Plugins can extend OpenClaw with:
...
pub struct PluginMetadata {
    ...
    pub min_openclaw_version: Option<Version>,
}
