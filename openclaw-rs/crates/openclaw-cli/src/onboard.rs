...
impl OnboardWizard {
    ...
    fn step_welcome(&self) {
        eprintln!();
        eprintln!("  {}", style("Welcome to OpenClaw!").bold().cyan());
...
"#,
        ...
        eprintln!(
            "    {} Start chatting",
            style("openclaw agent chat").cyan(),
        );
        eprintln!(
            "    {} Start the gateway",
            style("openclaw gateway start").cyan(),
        );
        eprintln!(
            "    {} Run diagnostics",
            style("openclaw doctor").cyan(),
        );
        eprintln!();
