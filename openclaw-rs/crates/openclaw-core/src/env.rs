...
pub mod vars {
    ...
    /// OpenClaw home directory override.
    pub const OPENCLAW_HOME: &str = "OPENCLAW_HOME";

    /// OpenClaw config file override.
    pub const OPENCLAW_CONFIG: &str = "OPENCLAW_CONFIG";

    /// OpenClaw log level.
    pub const OPENCLAW_LOG: &str = "OPENCLAW_LOG";

    /// OpenClaw debug mode.
    pub const OPENCLAW_DEBUG: &str = "OPENCLAW_DEBUG";
}
