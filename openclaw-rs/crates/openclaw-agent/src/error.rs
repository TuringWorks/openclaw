...
impl From<openclaw_sandbox::SandboxError> for AgentError {
    fn from(e: openclaw_sandbox::SandboxError) -> Self {
        Self::Sandbox(e.to_string())
    }
}

impl From<openclaw_channels::ChannelError> for AgentError {
    fn from(e: openclaw_channels::ChannelError) -> Self {
