//! Hello World Plugin for OpenClaw
//!
...
impl HelloPlugin {
    ...
    pub fn new() -> Self {
        Self {
            ...
            greeting: "Hello from OpenClaw!".to_string(),
            greeting_count: 0,
        }
    }
...
impl Plugin for HelloPlugin {
    fn metadata(&self) -> PluginMetadata {
        PluginMetadata {
            ...
            description: "A simple hello world plugin for OpenClaw".to_string(),
            author: Some("OpenClaw Contributors".to_string()),
            homepage: Some("https://github.com/openclaw/openclaw-rs".to_string()),
            license: Some("MIT".to_string()),
            capabilities: vec![PluginCapability::Tool],
            min_openclaw_version: Some(Version::parse("0.1.0").unwrap()),
        }
    }
...
mod tests {
    ...
    async fn test_hello_tool() {
        ...
        assert_eq!(output["message"], "Hello OpenClaw!");
        assert_eq!(output["name"], "OpenClaw");
    }
