...
Model providers enable OpenClaw to interact with various LLM APIs including Anthropic, OpenAI, Google, and others.
...
pub fn create_default_registry(config: &OpenClawConfig) -> ProviderRegistry {
